...
from user_srv.proto import user_pb2 as user__pb2
...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserList = channel.unary_unary(
                '/User/GetUserList',
                request_serializer=user__pb2.PageInfoRequest.SerializeToString,
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUserList': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.PageInfoRequest.FromString,
...
class User(object):
    ...
    def GetUserList(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/User/GetUserList',
            user__pb2.PageInfoRequest.SerializeToString,
